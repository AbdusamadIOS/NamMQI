...
class IssitishTGHCell: UITableViewCell {
    
    static let identifeir = "IssitishTGHCell"
    ...
    @objc func hisoblashButtonPress() {
        ...
        if suvningOrtachaZichligiTF.text == "" {
            suvningOrtachaZichligiTF.layer.borderColor = UIColor.red.cgColor
            suvningOrtachaZichligiTF.layer.borderWidth = 1
        } else if suvningHarakatTezligiTF.text == "" {
            suvningHarakatTezligiTF.layer.borderColor = UIColor.red.cgColor
            suvningHarakatTezligiTF.layer.borderWidth = 1
        } else if ishqalanishKoeffitsiyentiTF.text == "" {
            ishqalanishKoeffitsiyentiTF.layer.borderColor = UIColor.red.cgColor
            ishqalanishKoeffitsiyentiTF.layer.borderWidth = 1
        } else if uchastkaUzunligiTF.text == "" {
            uchastkaUzunligiTF.layer.borderColor = UIColor.red.cgColor
            uchastkaUzunligiTF.layer.borderWidth = 1
        } else if quvurIchkiDiametriTF.text == "" {
            quvurIchkiDiametriTF.layer.borderColor = UIColor.red.cgColor
            quvurIchkiDiametriTF.layer.borderWidth = 1
        } else if mahalliyQarshilikTF.text == "" {
            mahalliyQarshilikTF.layer.borderColor = UIColor.red.cgColor
            mahalliyQarshilikTF.layer.borderWidth = 1
        } else {
