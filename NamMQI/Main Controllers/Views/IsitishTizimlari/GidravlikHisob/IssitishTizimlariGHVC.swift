...
class IssitishTizimlariGHVC: UIViewController {
    ...
    func style() {
        ...
        tableView.register(IssitishTGHCell.self, forCellReuseIdentifier: IssitishTGHCell.identifeir)
    }
    func layout() {
...
extension IssitishTizimlariGHVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: IssitishTGHCell.identifeir, for: indexPath) as? IssitishTGHCell else { return UITableViewCell() }
