...
class MainVC: UIViewController {
    ...
    var categories: [Category] = [Category(image: UIImage(named: "isitish"), title: "Isitish tizimlari"),
                                  Category(image: UIImage(named: "ventil"), title: "Ventilyatsiya tizimlari")
    ]
...
extension MainVC: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        case 0:
            let vc = IsitishTizimlariVC()
            navigationController?.pushViewController(vc, animated: true)
        default:
            let vc2 = VentilyatsiyaTizimlariVC()
